...
const DISTRICT_QUERY = `*[_type == "district" && slug.current == "stpete"][0]{name, nickname, description, counties, heroImage}`;
const CHURCHES_QUERY = `*[_type == "church" && district == "St. Petersburg District"] | order(name asc){name, address, city, state, zip, county, pastor, phone, website}`;
const EVENTS_QUERY = `*[_type == "event" && district == "St. Petersburg District" && date >= now()] | order(date asc){_id, title, date, location, description}`;
...
const fallbackDistrict: District = {
    ...
    counties: ['Pinellas', 'Manatee', 'Sarasota'],
};
...
export default async function StPeteDistrictPage() {
    ...
    const heroUrl = info.heroImage
        ...
        : '/assets/districts/stpete-hero.jpg';
        ...
        <div className="bg-white">
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="text-center mb-10">
                            ...
                            <h2 className="text-[#0A1F44]" style={{ fontFamily: "'Playfair Display', serif", fontSize: '2rem', fontWeight: 700 }}>
                                Upcoming in the St. Petersburg District
                            </h2>
                        </div>
            ...
            <section className="px-6 py-16">
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        Churches in the St. Petersburg District
                    </h2>
