...
const DISTRICT_QUERY = `*[_type == "district" && slug.current == "lakeland"][0]{name, nickname, description, counties, heroImage}`;
const CHURCHES_QUERY = `*[_type == "church" && district == "Lakeland District"] | order(name asc){name, address, city, state, zip, county, pastor, phone, website}`;
const EVENTS_QUERY = `*[_type == "event" && district == "Lakeland District" && date >= now()] | order(date asc){_id, title, date, location, description}`;
...
export default async function LakelandDistrictPage() {
    ...
    const heroUrl = info.heroImage
        ...
        : '/assets/districts/lakeland-hero.jpg';
        ...
        <div className="bg-white">
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="text-center mb-10">
                            ...
                            <h2 className="text-[#0A1F44]" style={{ fontFamily: "'Playfair Display', serif", fontSize: '2rem', fontWeight: 700 }}>
                                Upcoming in the Lakeland District
                            </h2>
                        </div>
            ...
            <section className="px-6 py-16">
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        Churches in the Lakeland District
                    </h2>
