;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="63c02d71-2638-9a22-08b6-4f6e0d15c87f")}catch(e){}}();
module.exports = [
...
"[project]/node_modules/@sentry/node/build/cjs/integrations/node-fetch/undici-instrumentation.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function onRequestCreated(config, { request }) {
    ...
    const shouldIgnoreReq = safeExecute(()=>request.method === "CONNECT" || !!config.ignoreOutgoingRequests?.(url$1), (e)=>e && debugBuild.DEBUG_BUILD && core.debug.error("caught ignoreOutgoingRequests error: ", e));
    if (shouldIgnoreReq) {
        return;
    }
    let requestUrl;
...
const undiciInstrumentation = __turbopack_context__.r("[project]/node_modules/@sentry/node/build/cjs/integrations/node-fetch/undici-instrumentation.js [instrumentation] (ecmascript)");
const core = __turbopack_context__.r("[project]/node_modules/@sentry/core/build/cjs/index.js [instrumentation] (ecmascript)");
const nodeCore = __turbopack_context__.r("[project]/node_modules/@sentry/node-core/build/cjs/index.js [instrumentation] (ecmascript)");
...
exports.ATTR_HTTP_METHOD = ATTR_HTTP_METHOD;
}),
...
function experimentalUseDiagnosticsChannelInjection() {
    diagnosticsChannelInjection.setDiagnosticsChannelInjectionLoader(()=>{
        const integrations = [
            ...
            orchestrion.lruMemoizerChannelIntegration()
        ];
...
//# debugId=63c02d71-2638-9a22-08b6-4f6e0d15c87f
//# sourceMappingURL=node_modules_%40sentry_node_build_cjs_0w8hp1f._.js.map